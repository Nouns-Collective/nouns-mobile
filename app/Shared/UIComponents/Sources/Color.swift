...
/// Various components `RadialGradient`
extension RadialGradient {
    
    /// A context-dependent Rainbow color suitable for use in UI elements.
    public static var componentRainbow: some View {
    ...
    public static var componentPopsicle: some View {
        GeometryReader { proxy in
            RadialGradient(
                colors: [
                    .componentAubergine,
    ...
    public static var componentWatermelon: some View {
        GeometryReader { proxy in
            RadialGradient(
                colors: [
                    .componentMelon,
    ...
    public static var componentCantalope: some View {
        GeometryReader { proxy in
            RadialGradient(
                colors: [
                    .componentSoftPeach,

...
final class CloudConfigurationTests: XCTestCase {
    ...
    func testCloudConfigurationNounQueryURL() {
        let expectedURL = URL(string: "https://api.goldsky.com/api/public/project_cldf2o9pqagp43svvbk5u3kmo/subgraphs/nouns/prod/gn")
        XCTAssertEqual(CloudConfiguration.Nouns.query.url, expectedURL)
    }
    
    func testCloudConfigurationNounSubcriptionURL() {
        let expectedURL = URL(string: "wss://api.goldsky.com/api/public/project_cldf2o9pqagp43svvbk5u3kmo/subgraphs/nouns/prod/gn")

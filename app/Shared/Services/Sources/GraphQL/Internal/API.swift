...
/// Apollolib namespace
public enum Apollolib {
  public enum ProposalStatus: RawRepresentable, Equatable, Hashable, CaseIterable, Apollo.JSONDecodable, Apollo.JSONEncodable {
    ...
    public static func == (lhs: ProposalStatus, rhs: ProposalStatus) -> Bool {
      switch (lhs, rhs) {
        case (.pending, .pending): return true
        case (.active, .active): return true
        case (.cancelled, .cancelled): return true
        case (.vetoed, .vetoed): return true
        case (.queued, .queued): return true
        case (.executed, .executed): return true
  ...
  public final class ProposalsListQuery: GraphQLQuery {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      query ProposalsList($skip: Int, $first: Int) {
    ...
    public let operationName: String = "ProposalsList"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("proposals", arguments: ["skip": GraphQLVariable("skip"), "first": GraphQLVariable("first"), "orderBy": "startBlock", "orderDirection": "desc"], type: .nonNull(.list(.nonNull(.object(Proposal.selections))))),
        ]
      }
      ...
      public init(proposals: [Proposal]) {
        self.init(unsafeResultMap: ["__typename": "Query", "proposals": proposals.map { (value: Proposal) -> ResultMap in value.resultMap }])
      }

      public var proposals: [Proposal] {
        get {
          return (resultMap["proposals"] as! [ResultMap]).map { (value: ResultMap) -> Proposal in Proposal(unsafeResultMap: value) }
        }
        set {
          resultMap.updateValue(newValue.map { (value: Proposal) -> ResultMap in value.resultMap }, forKey: "proposals")
        }
      }
      ...
      public struct Proposal: GraphQLSelectionSet {
        ...
        public static var selections: [GraphQLSelection] {
          return [
            GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
            GraphQLField("startBlock", type: .nonNull(.scalar(String.self))),
            GraphQLField("endBlock", type: .nonNull(.scalar(String.self))),
            GraphQLField("description", type: .nonNull(.scalar(String.self))),
            GraphQLField("status", type: .nonNull(.scalar(ProposalStatus.self))),
          ]
        }
        ...
        public init(startBlock: String, endBlock: String, description: String, status: ProposalStatus) {
          self.init(unsafeResultMap: ["__typename": "Proposal", "startBlock": startBlock, "endBlock": endBlock, "description": description, "status": status])
        }
        ...
        public var startBlock: String {
          get {
            return resultMap["startBlock"]! as! String
          }
          set {
            resultMap.updateValue(newValue, forKey: "startBlock")
          }
        }
        ...
        public var endBlock: String {
          get {
            return resultMap["endBlock"]! as! String
          }
          set {
            resultMap.updateValue(newValue, forKey: "endBlock")
          }
        }
        ...
        public var status: ProposalStatus {
          get {
            return resultMap["status"]! as! ProposalStatus
          }
          set {

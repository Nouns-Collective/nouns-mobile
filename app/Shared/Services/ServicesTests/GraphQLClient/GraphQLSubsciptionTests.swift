...
class GraphQLSubsciptionTests: XCTestCase {
  ...
  func testSuccessfulResponse() throws {
    ...
    mockApolloClient.set(subscriptionResult: .init(data: [AuctionSubscription.Data(auctions: [.init(id: GraphQLID("1"), amount: "0", startTime: "100", endTime: "120", settled: false)]),
                                                          AuctionSubscription.Data(auctions: [.init(id: GraphQLID("1"), amount: "0", startTime: "100", endTime: "120", settled: false)])], errors: nil), error: nil)
